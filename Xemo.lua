...
local Tabs = {
    Settings = Wings:AddTab({ Title = "Setting Fram", Icon = "" }),
    ...
    SU = Window:AddTab({ Title = "Sub-Framing", Icon = "" }),
...
do
    Fluent:Notify({
    Title = "Xemo Hub",
    Content = "https://discord.gg/YzrVW3FZ",
    SubContent = "@"..game.Players.LocalPlayer.Name.." wait Script load..", -- Optional
    Duration = 5 -- Set to nil to make the notification not disappear
})
    
local Dropdown = Tabs.Main:AddDropdown("Fram Type", {
        Title = "Choose Method To Fram",
                            ...
                            if getCakePrince() then
                                ...
                                if Target then
                                    if game.Workspace.Enemies:FindFirstChild(Target.Name) then
                                        ...
                                        EquipWeapon()
                                        if
                                            GetDistance(Ce.new(-1990.672607421875, 4532.99951171875, -14973.6748046875)) >
                                                3000
                                         then
                                            Tweento(
                                                Ce.new(
                                            ...
                                            Tweento(Target.HumanoidRootPart.Ce * GetCeADD())
                                        end
                                    end
                                end
                            else
   ...
   local Toggle = Tabs.Main:AddToggle("Fram Normal", {Title = "Start Fram", Default = false })
...
ImageButton1.Position = UDim2.new(0.48888889, 0, 0.48888889, 0)
