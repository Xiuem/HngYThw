...
local Tabs = {
    ...
    SF = Window:AddTab({ Title = "Settings Fram", Icon = "" })
    ...
    LC = Window:AddTab({ Title = "Local Player", Icon = "atom" }),
...
function RedeemCode(value)
   ...
   _G.AutoBuyEnchancementColour = Value
    ...
    local Toggle = Tabs.O:AddToggle("MyToggle", {Title = "Buy Legendary Sword", Default = false })
   ...
   _G.AutoBuyLegendarySword = Value
    ...
    local Toggle = Tabs.O:AddToggle("MyToggle", {Title = "Random Bone", Default = false })
