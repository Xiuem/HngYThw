...
object.GetKey = instance.new("TextButton", {
    ...
    Name = "GetKey";
    Parent = object.Main;
    Position = UDim2.new(0.51810205, 0, 0.7429479 ko 96, 0);
...
local function wl(key)
    ...
    if sign_match == decode_response.sign then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Xiuem/Function/refs/heads/main/FastAttackLoader.lua?token=GHSAT0AAAAAAC4EPEMWPH5YUT7GBFTDY2F2Z44JIEA"))()
        -- Final Load --
        LoadedUiHub = true
        Window:SelectTab(1)
        Fluent:Notify(
